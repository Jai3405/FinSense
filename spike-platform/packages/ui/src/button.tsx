...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-spike-gradient text-white shadow hover:opacity-90",
        destructive:
        ...
        link: "text-spike-primary underline-offset-4 hover:underline",
        success: "bg-spike-bull text-white shadow hover:bg-spike-bull/90",
        warning: "bg-spike-warning text-white shadow hover:bg-spike-warning/90",
      },
      size: {
